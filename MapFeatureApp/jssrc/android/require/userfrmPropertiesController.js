    ...
    featureSelected: function() {
        try {
            ...
            switch (this.view.segFeatureOptions.selectedRowIndex[1]) {
                case 0:
                    formToBeNavigated = "frmCircle";
                    break;
                case 1:
                    formToBeNavigated = "frmPolygon";
                    break;
                case 2:
                    formToBeNavigated = "frmAddPin";
                    break;
                case 3:
                    formToBeNavigated = "frmMultiplePinsDockedCallout";
                    break;
                case 4:
                    formToBeNavigated = "frmClustered";
                    break;
                default:
