define({
    ...
    animateFlexToSmall: function() {
        var deviceHeight = kony.os.deviceInfo().screenHeight;
        var topValue = deviceHeight - (this.currentheight + 15);
    ...
    doLayoutCallback: function() {
        this.currentheight = this.view.flxRoutes.frame["height"];
        this.view.flxRoutes.doLayout = this.dummy;
    },
    dummy: function() {
        kony.print("dummy");
    }
